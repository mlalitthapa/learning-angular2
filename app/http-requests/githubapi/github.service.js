System.register(['angular2/http', 'angular2/core', 'rxjs/Observable', 'rxjs/add/operator/map', 'rxjs/add/observable/forkJoin'], function(exports_1) {
    ...
    return {
        ...
        execute: function() {
            GithubService = (function () {
                ...
                GithubService.prototype.getUserWithFollowers = function (username) {
                    return Observable_1.Observable.forkJoin(this.getUser(username), this.getFollowers(username));
                };
